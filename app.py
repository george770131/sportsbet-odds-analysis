"""
🏛️ 機構級體育博弈量化分析終端 (Institutional Sports Quantitative Terminal)
專注於 棒球 (MLB, NPB, CPBL) 與 電競 (LCK, LPL)
具備 澳洲 Sportsbet 官方操作盤口、Oddsportal 國際即時場中數據中樞、跨機構隱藏勝率落差、去水真實勝率、
...
# ==========================
# 💼 專業現代金融量化風格 CSS (Bloomberg / Dark Cyber Slate)
# ==========================
st.markdown("""
<style>
